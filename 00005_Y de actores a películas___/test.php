public function testActor(): void {
  ...
  $this->assertTrue($pelicula->getTable() === "actors", "La tabla de la tabla de actores debe llamarse 'actors'");
  
  $this->assertTrue($pelicula->getPrimaryKey() === "id", "La primary key de la tabla de actores debe llamarse 'id'"); 
  
  $this->assertTrue($pelicula->getTimestamps() === true, "Es necesario aclarar que la tabla de actores si tiene los timestamps");
